...
class MaWrapper(ABC):
    ...
    def __init__(self, env_id: str, seed: int = 0, max_steps: int = 0, **kwargs) -> None:
        """
        Args:
    ...
    def __init__(self, seed: int = 0, max_steps: int = 0) -> None:
        ...
        Args:
            ...
            print_cols (bool): A flag used to print the columns to the console
                (default is False)
        """
        super().__init__('simple_reference', seed, max_steps)
        ...
        self.tg_goal = np.zeros((self.env.n, ma_shape[1]))
    ...
    def __init__(self, seed: int = 0, max_steps: int = 100) -> None:
        ...
        Args:
            ...
            print_cols (bool): A flag used to print the columns to the console
                (default is False)
        """
        self.env_params = {'num_agents': 3, 'num_landmarks': 3}
        super().__init__('simple_spread', seed, max_steps, **self.env_params)
