...
class Scenario(BaseScenario):
    ...
    def observation(self, agent, world):
        ...
        # emarche: added [agent.state.p_pos] and replaced [color] with [id]
        return np.concatenate([agent.state.p_vel] + [agent.state.p_pos] + entity_pos + [goal_id] + comm)
