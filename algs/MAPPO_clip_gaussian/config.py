...
def parse_args():
    ...
    parser.add_argument("--env", type=str, default="SpreadWrapper", help="the name of the gym environment") 
    ...
    # Experiment
    parser.add_argument("--n-steps", type=int, default=1000, help="the number of steps between policy updates")
    parser.add_argument("--tot-steps", type=int, default=2000000, help="total timesteps of the experiments")

    # Algorithm 
    # emarche: looks like Spread requires a gamma = 0.9
    ...
    # wandb
    parser.add_argument("--wandb-project-name", type=str, default="MPE_v2", help="the wandb's project name")
